...
const TextLoopReveal: FC<TextLoopRevealProps> = ({
  ...
  return (
    <span
      ref={ref}
      className={cn(
        "flex w-full flex-wrap justify-center text-center lg:justify-start lg:text-left bg-gradient-to-r from-zinc-300 via-zinc-100 to-white bg-clip-text text-transparent",
        className,
      )}
    >
