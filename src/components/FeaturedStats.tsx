      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
          ...
          <div className="flex-1 w-full">
            <ScrollAnimate delay={0.1} duration={0.6} y={30}>
              <p className="text-lg md:text-xl lg:text-2xl text-foreground leading-relaxed mb-8">
                ...
                <span className="text-muted-foreground">
                  Nuestro panel de análisis de próxima generación te ayuda a rastrear el rendimiento, gestionar clientes y tomar decisiones basadas en datos en segundos.
                </span>
              </p>
            </ScrollAnimate>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              {stats.map((stat, index) => (
                ...
                >
                  <motion.div
                    className="bg-card border border-border rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow duration-300"
          ...
          <ScrollAnimate delay={0.4} duration={0.8} y={40} className="flex-1 w-full">
            <motion.div
              className="h-[250px] md:h-[350px] w-full bg-card border border-border rounded-2xl p-4 md:p-6 shadow-sm"
