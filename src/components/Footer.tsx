  ...
  return (
    <footer className="relative bg-background pt-8 pb-6">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="relative rounded-3xl bg-foreground p-8 md:p-12 lg:p-16">
          {/* Logo */}
          <div className="mb-12">
            <img 
              src={logoImage} 
            ...
            <div className="flex flex-wrap items-center gap-6 mb-8">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="flex items-center gap-2 text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors duration-200 cursor-pointer"
